...
public class PersonMonitor {
    ...
    @AfterReturning(value="execution(* com.apress.cems.aop.service.*Service+.save*(..)))",
    returning="result")
    ...
    @AfterThrowing(value="execution(* com.apress.cems.*.*Repo+.update*(..)))",
            throwing="e")
    ...
    public Object aroundFind(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        try {
            ...
            logger.info("returnType {} , returnedObject {}", returnType, obj);
